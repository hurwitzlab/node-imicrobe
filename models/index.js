...
models.project.addScope('withUsers',
    {
        include: [ {
            model: models.user,
            as: "users",
            attributes: [ 'user_id', 'user_name', 'first_name', 'last_name' ],
            through: { attributes: [ 'permission' ] } // remove connector table
        } ]
    }
);

models.project.addScope('withGroups',
    {
        include: [
...
models.project_group.addScope("withUsers",
    {
        include: [ {
            model: models.user,
            as: "users",
            attributes: [ 'user_id', 'user_name', 'first_name', 'last_name' ],
            through: { attributes: [ 'permission' ] } // remove connector table from output
        } ]
    }
);